          ...
          >
            ...
            <div className="flex items-center justify-center">
              <a
                ...
                className="group bg-[var(--color-deep)] text-white px-10 py-6 rounded-2xl font-medium hover:bg-[var(--color-deep-muted)] transition-all flex items-center justify-center gap-4 shadow-lg"
              >
                {/* Apple Logo */}
                ...
                <div className="text-left">
                  ...
                  <span className="text-xl">macOS Silicon</span>
                </div>
              </a>
            </div>
